...
- `scy_brain_onboarding_spec.md` / `scy_brain_onboarding_plan.md` / `scy_brain_onboarding_tasks.md` / `scy_brain_onboarding_tests.md`

## 🔗 Référence
PRD §7.7ter (Onboarding Gamifié), §7.7 (SPEC-BRAIN-ONBOARDING-V1). Pattern : Duolingo (+40% rétention J7), Brilliant.

Référez-vous à **`s00_architecture_standards/`**.

...
**ID Module** : S08_SCY_READER_SUITE  
...
## 🧭 Fiche de Synthèse
* **Description Fonctionnelle** : Le triptyque de lecture bionique active immersif.
* **Stack Technique Officielle** : React 18, @react-pdf-viewer/core, KaTeX (Math), PrismJS (Code)
* **Patterns d'Ingénierie à Respecter** : Active Reading Layer, Multi-Vues Toggles, Page Gallery cache

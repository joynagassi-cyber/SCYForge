...
**ID Module** : S08_READER_SUITE_EXPORT  
**Statut** : 🟢 FORMATS ET CRATES HISTOLOGIQUEMENT SÉCURISÉS ET TYPES  

---

## 1. Spécification des 9 Formats d'Exportation
SCY Forge permet d'exporter l'intégralité du matériel sémantique d'un nœud ou d'un projet dans 9 formats standards de niveau de production :

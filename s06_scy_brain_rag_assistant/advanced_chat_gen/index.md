...
- `scy_advanced_chat_spec.md` / `scy_advanced_chat_plan.md` / `scy_advanced_chat_tasks.md` / `scy_advanced_chat_tests.md`

## 🔗 Référence
PRD §7.7bis. Stack UI : Vercel AI SDK (streaming premium, graphiques inline, UI générative).

...
Cette architecture "Plugin Arborization" a été abandonnée au profit de COSMOS v5.
Le signal utile (KB→KG→STB pipeline, Insight Engine, 3-layer architecture, lianes) a été recyclé dans COSMOS v5 comme "Data Substrate".
Ne pas utiliser ce document comme référence d'architecture active.
Date d'archivage : 2026-07-02
-->

# SCYForge — COSMOS Plugin Infrastructure (C) : Arborisation du Graphe & Moteur d'Insights [ARCHIVÉ]

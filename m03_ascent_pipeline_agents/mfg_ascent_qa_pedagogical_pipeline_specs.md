...
**Document ID** : SPEC-MFG-ASCENT-QA-PIPELINE-V1.0  
**Date** : 2026-06-12  
...
```typescript
// features/m03_ascent_pipeline_agents/mfg_ascent_qa_alignment.ts
...
Le **Pedagogical Quality Score (PQS)** $S_{\text{pqs}} \in [0, 100]$ détermine si le cours est digne de débloquer l'accès à une certification officielle MindForge.

...
SCY Forge est une **plateforme d'apprentissage augmentée par l'IA** qui agit comme un **prolongement transparent de la pensée**. L'interface favorise un **état de flux (flow state)** pour des sessions longues (25+ minutes) en minimisant la fatigue visuelle.
...
Dans un contexte éducatif, le rouge stimule le stress lié à l'erreur ou à l'échec scolaire. SCY Forge utilise l'**Or/Ambre** (#D97706) pour signaler les points à réviser, transformant l'erreur en **opportunité de maîtrise**.
...
SCY Forge utilise des ombres subtiles pour créer de la profondeur sans surcharger l'interface dark mode.
...
- **Contrainte d'Enveloppe Cérébrale** : Tracé en pointillés violet translucide (`rgba(30, 27, 75, 0.2)`) selon l'Équation de Sagittal de SCY Forge.
...
*Ce document est la référence contractuelle pour l'implémentation visuelle de SCY Forge. En cas de conflit entre ce document et tout wireframe, mock ou import, ce document prévaut.*
